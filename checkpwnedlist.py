#github: techno hwizdry checkpwnedemails
__OriginalAuthor__  = "Alexan Mardigian"
__Edited_By__ = "Thomas Reid Zuk"
__version__ = "1.1.1"
...
def write_results_to_file(filename, results, opts):
	...
	file_headers = {
			BREACHESTXT: "Email Address\tIs Pwned\tPwn Count\tDomain Name\tIs Sensitive\tName\tTitle\tData Classes\tIs Retired\tIs Spam List\tLogo Type\tBreach Date\tIs Fabricated\tDate Added\tModified Date\tIs Active\tIs Verified\tDescription",
